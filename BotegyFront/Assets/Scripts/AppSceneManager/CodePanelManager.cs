...
namespace AppSceneManager
{
    public class CodePanelManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            // ValueBlock v2 = new ValueBlock("2", ValueType.INT);
            // AssignBlock b = new AssignBlock(v1, v2);
            //
        ...
        private void ShowConditionWindow()
        {
            ...
            conditionDialog.Show(hasElse, () => { }, ( e) =>
            {
                AddElse(e, hasElse);
            });
        }
        ...
        {
            return UIToBlockConverter.Convert(codePanel);
        }
