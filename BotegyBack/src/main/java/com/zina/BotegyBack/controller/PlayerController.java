...
public class PlayerController {
    ...
    public ResponseEntity<Player> updatePlayerPass(@RequestParam String userId,
                                                   @RequestParam String oldPass,
                                                   @RequestParam String pass
    ) {
        Optional<Player> p = playerService.updatePass(UUID.fromString(userId), pass, oldPass);
